...
public class ActividadSuma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reproducir();
        tvNum1 = findViewById(R.id.tvNum1S);
        tvNum2 = findViewById(R.id.tvNum2S);

        ratingBar = findViewById(R.id.ratingBar);
        ratingBar.setEnabled(false);
        ratingBar.setVisibility(View.INVISIBLE);

        etRespuesta = findViewById(R.id.etRespuestaSuma);

        btn1 = findViewById(R.id.btnOp1S);
        btn2 = findViewById(R.id.btnOp2S);
        btn3 = findViewById(R.id.btnOp3S);



        btnVolver = findViewById(R.id.btnVolverSuma);
        ...
        btnNext = findViewById(R.id.btnNextSuma);
    ...
    //Este método creará 2 numeros y su resultado de suma
